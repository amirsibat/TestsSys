...
public class StartExam extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            record.mExtraData.put("status", Record.RecordExamStatus.IN_PROGRESS.ordinal());
            record.mExtraData.put("startDate", new Date().getTime());
            record.mExtraData.put("answers", json.getJSONArray("answers"));
            record.update();
