...
/**
 * Servlet implementation class GetTeacherStatistics
 */
@WebServlet("/GetTeacherStatistics")
public class GetTeacherStatistics extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 response.setContentType("application/json; charset=UTF-8");
	        ...
	        try {
	            JSONObject json = Record.getStatisticsTeacher(user.mId);
