...
/**
 * Servlet implementation class GetOnlineExams
 */
@WebServlet("/GetOnlineExams")
public class GetOnlineExams extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetOnlineExams() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<Exam> exams = Record.getCurrentExamsByTeacher(user.mId);
