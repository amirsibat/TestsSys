...
public class SqlStatements {
	...
	public static final String COURSE_INSERT_NEW_COURSE = "INSERT INTO " + COURSE_TABLE + " ( " + SqlColumns.COURSE_ID
			+ ", " + SqlColumns.COURSE_NAME + ", " + SqlColumns.COURSE_PROFESSION_ID + ") VALUES(?,?,?)";
	public static final String COURSE_UPDATE_EXISTING_COURSE = "UPDATE " + COURSE_TABLE + " SET "
			+ SqlColumns.COURSE_NAME + "=? , " + SqlColumns.COURSE_PROFESSION_ID + "=? WHERE " + SqlColumns.COURSE_ID
			+ "=?";
	...
	public static final String QUESTION_INSER_NEW_QUESTION = "INSERT INTO " + QUESTION_TABLE + " ("
			...
			+ SqlColumns.QUESTION_CORRECT_ANSWER + ", " + SqlColumns.QUESTION_TEACHER_ID + ", "
			+ SqlColumns.QUESTION_PROFESSION_ID + ", " + SqlColumns.QUESTION_QUESTION_OPTIONS1 + ", "
			+ SqlColumns.QUESTION_QUESTION_OPTIONS2 + ", " + SqlColumns.QUESTION_QUESTION_OPTIONS3 + ", "
			+ SqlColumns.QUESTION_QUESTION_OPTIONS4 + ", " + SqlColumns.QUESTION_COURSES_LIST
			+ ") VALUES(?,?,?,?,?,?,?,?,?,?)";
