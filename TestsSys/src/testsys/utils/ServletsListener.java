...
//            L.err(e);
    ...
    private void createRecord() {
        try {
            ...
            Database.getInstance().executeUpdate(SqlStatements.RECORD_INSERT_NEW_RECORD, "3", "0008", "01", "010101", "{\"teacherId\":\"0006\",\"status\":1,\"answers\":[3,2,1,4,3],\"totalGrade\":30,\"startDate\":1466211816920, \"endDate\":1466213016920, \"duration\":40}");
            Database.getInstance().executeUpdate(SqlStatements.RECORD_INSERT_NEW_RECORD, "4", "0008", "01", "010101", "{\"teacherId\":\"0006\",\"status\":0,\"answers\":[3,2,1,4,3],\"totalGrade\":30,\"startDate\":1466211816920, \"endDate\":1466213016920, \"duration\":40}");
