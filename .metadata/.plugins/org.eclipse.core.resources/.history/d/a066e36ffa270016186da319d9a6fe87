...
public class createTables implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event)  { 
    	...
    	try{
    		...
    		BasicDataSource ds = (BasicDataSource)context.lookup("java:comp/env/jdbc/CqaDatasource");
    		...
    		try{
    			...
    			//stmt.executeUpdate("DROP TABLE LIKEANSWER");
    			...
    			//stmt.executeUpdate("DROP TABLE ANSWERS");
    			//stmt.executeUpdate("DROP TABLE LIKEQUEST");
    			//stmt.executeUpdate("DROP TABLE DISLIKEQUEST");
    			...
    			stmt.executeUpdate("CREATE TABLE LIKEQUEST( ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), "
    					+ "userID INTEGER NOT NULL,Liked_questID INTEGER NOT NULL, PRIMARY KEY (ID) )");
    			
    			stmt.executeUpdate("CREATE TABLE DISLIKEQUEST( ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), "
    			...
    			stmt.executeUpdate("CREATE TABLE USERS( userID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), "
    					+ "UserName varchar(255) NOT NULL, Password varchar(255) NOT NULL, Nickname varchar(255) NOT NULL, Description varchar(32672), "
    					+ "PhotoURL varchar(255), PRIMARY KEY (userID) )");
